...
describe CsvExport do
  ...
  it 'returns the correct CSV' do
    expected = [
      {"uuid"=>"politician1", "female"=>nil, "male"=>"1", "other"=>nil, "skip"=>nil, "total"=>"1"},
      {"uuid"=>"politician2", "female"=>nil, "male"=>"1", "other"=>nil, "skip"=>nil, "total"=>"1"},
      {"uuid"=>"politician3", "female"=>"1", "male"=>nil, "other"=>nil, "skip"=>nil, "total"=>"1"}
    ]
